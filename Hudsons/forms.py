...
class CalcForm(forms.ModelForm):
    ...
    quant_pag = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control', 'min': 1, 'required': 'required'}))
    custo_pag = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control', 'min': 1, 'required': 'required'}))
