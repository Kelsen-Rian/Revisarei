...
def calcular_medias(request):
    if request.method == "GET":
        ...
        if quantidade > 0:
            ...
            # Filtra os serviços onde custo_diagramacao é diferente de 0 antes de calcular a média
            servicos_diagramacao = servicos.exclude(custo_diagramacao=0)
            media_diagramacao = servicos_diagramacao.aggregate(avg_diagramacao=Avg("custo_diagramacao"))["avg_diagramacao"] or 0
